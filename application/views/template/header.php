   ...
   <body class="hold-transition skin-blue sidebar-mini">
      ...
      <aside class="main-sidebar">
         ...
         <section class="sidebar">
            ...
            <?php endforeach; ?>                     
            <li class="treeview <?php echo (in_array($active, array('business_setting', 'currencies', 'customers', 'product_category', 'product')) ? 'active' : ''); ?>">
            ...
            <?php if($_SESSION['company'] == 'bmg'): ?>
            <li><a href="<?php echo site_url('main/set_company/as'); ?>"><i class="fa fa-map-o"></i> <span>AS MENA</span></a></li>
            <?php else: ?>
            <li><a href="<?php echo site_url('main/set_company/bmg'); ?>"><i class="fa fa-map-o"></i> <span>BMG</span></a></li>
            <?php endif; ?>
