            ...
            <div class="box-body">
               <?php echo form_open_multipart('booking/insert', array('id' => 'addForm')); ?>
                  ...
                  <div class="form-group" style="text-align: right;">
                     ...
                     <?php  
                           $bnum = 1;
                           $bnumber = strtoupper($_SESSION['company']).'0000-00-000';
                           
                           if($last_booking) {
                              $bnumber = $last_booking->booking_name;
                           }

                           if($_SESSION['company'] == 'as') {
                              $hundreds = (int) substr($bnumber, 10, 1);
                              $tens = (int) substr($bnumber, 11, 1);
                              $ones = (int) substr($bnumber, 12, 1);
                     ...
                     ?>
                     <input type="hidden" value="" id="booking_name" name="booking_name" class="">                                       
                  </div>
...
<script>
   ...
   $('#po_date').change(function() {
      ...
      var yr = split[0];
      var mm = split[1];
      var booking = '<?php echo strtoupper($_SESSION['company']); ?>'+yr+'-'+mm+'-<?php echo $bnum; ?>';
